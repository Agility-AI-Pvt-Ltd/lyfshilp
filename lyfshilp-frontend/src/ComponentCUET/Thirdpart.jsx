...
import YugImg from "../assets/CuetCimg/Yug.png";
import ShreyaImg from "../assets/CuetCimg/Shreya.png";
import SharadaImg from "../assets/CuetCimg/Sharada.png";
...
export default function Testimonials() {
  const testimonials = [
    ...
    {
      text: "The academy is really very helpful and the teachers are also very understanding, friendly and cooperative. They help students upto their best extent. Must say, best academy..Apart from the timings given for the respective classes, they provide an extra self - study timings as well..!",
      name: "Shreya Singh",
      img: ShreyaImg,
    },
    {
      text: "Lyfshilp Academy is truly a game-changer! The teachers are not just knowledgeable but also deeply passionate about teaching. The personalized attention, well-structured courses, and supportive environment make learning a joy. Whether you're looking to upgrade your skills or start fresh, this academy is the perfect place to be!",
      name: "Sharada Kumari",
      img: SharadaImg,
    },
  ];
  ...
  const [expanded, setExpanded] = useState({}); // ✅ For "More/Less" toggle
