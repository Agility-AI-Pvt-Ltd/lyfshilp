    ...
    <section className="relative py-16 px-6 sm:px-10 md:px-16 lg:px-24 bg-[#FFF8EE] overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto w-full">
        ...
        <div className="text-center mb-12">
          ...
          <p className="mt-5 bg-green-600 text-white font-semibold py-2 px-5 text-sm sm:text-base lg:text-lg tracking-wide rounded-md inline-block shadow-md">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="leading-tight space-y-8">
            ...
            <div className="bg-green-50 rounded-xl p-6 shadow-md border-l-4 border-green-500 leading-snug">
              ...
              <p className="text-gray-700 text-sm sm:text-base">
                The FutureX Fellowship provides expert-led, ready-to-launch programs to your school, enabling
