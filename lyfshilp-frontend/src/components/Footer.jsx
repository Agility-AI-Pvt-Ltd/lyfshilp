    ...
    <footer className="bg-green-800 text-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10">
        ...
        <div className="flex flex-col items-center sm:items-start text-center sm:text-left">
          ...
          <p className="text-gray-200 text-sm leading-relaxed mb-6 max-w-xs sm:max-w-none text-center sm:text-left">
        ...
        {/* Partners */}
        <div className="text-center sm:text-left">
          <h3 className="font-semibold mb-4 text-lg">Partners</h3>
          <ul className="space-y-2 text-gray-200 text-sm">
            <li>
              <a
