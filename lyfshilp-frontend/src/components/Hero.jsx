...
export default function Hero() {
  return (
    <section className="bg-white pt-16 sm:pt-20 md:pt-24 pb-6 sm:pb-8 md:pb-10 font-sans relative overflow-hidden flex md:items-center items-start min-h-[75vh] md:min-h-[90vh]">
      <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-10 grid grid-cols-1 md:grid-cols-2 items-center gap-6 sm:gap-8 md:gap-10 max-w-7xl">
        ...
        <div className="max-w-xl mx-auto md:mx-0 text-center md:text-left order-2 md:order-1">
          ...
          {/* Subheading */}
          <p className="text-gray-600 text-xs sm:text-sm md:text-base leading-relaxed mb-6 text-center md:text-left max-w-lg mx-auto md:mx-0">
          ...
          <div className="flex justify-center md:justify-start mt-4 sm:mt-6">
            <Link
              to="/exam-prep"
              className="inline-flex items-center bg-green-600 text-white px-6 sm:px-7 md:px-8 py-3 sm:py-3.5 rounded-full font-semibold shadow-lg hover:bg-green-700 hover:shadow-xl transform hover:scale-105 transition duration-300 group text-sm sm:text-base"
            >
              Start Learning
...
{/* Right Image */}
<div className="flex justify-center md:justify-end items-center relative order-1 md:order-2 mt-4 sm:mt-6 md:mt-0">
