  ...
  useEffect(() => {
    ...
    function draw() {
      ...
      for (let lat = -80; lat <= 80; lat += 10) {
        ...
        ctx.strokeStyle =
          lat === 0 ? "rgba(212,180,104,0.22)" : "rgba(140,175,120,0.07)";
      ...
      CONNECTIONS.forEach(([a, b], idx) => {
        ...
        const cpY =
          (pa.y + pb.y) / 2 - Math.hypot(pa.x - pb.x, pa.y - pb.y) * 0.22;
        ...
        if (pulse?.active) {
          ...
          const t = pulse.t;
          const px =
            (1 - t) * (1 - t) * pa.x + 2 * (1 - t) * t * cpX + t * t * pb.x;
          const py =
            (1 - t) * (1 - t) * pa.y + 2 * (1 - t) * t * cpY + t * t * pb.y;
      ...
      proj.forEach((p, i) => {
        ...
        ctx.beginPath();
        ctx.arc(p.x, p.y, 5 + pingT * 20, 0, Math.PI * 2);
        ...
        ctx.beginPath();
        ctx.arc(p.x, p.y, 5 + pingT2 * 20, 0, Math.PI * 2);
        ...
        ctx.fillStyle = `rgba(255,245,200,${depth})`;
        ctx.fill();
        ctx.beginPath();
      ...
      ctx.beginPath();
      ctx.arc(cx, cy, R, 0, Math.PI * 2);
      ctx.strokeStyle = "rgba(212,180,104,0.45)";
      ctx.lineWidth = 1.5;
      ctx.stroke();
      ctx.beginPath();
      ctx.arc(cx, cy, R, 0, Math.PI * 2);
      ctx.strokeStyle = "rgba(255,235,160,0.2)";
      ctx.lineWidth = 0.5;
      ctx.stroke();
      ...
      ctx.strokeStyle = "rgba(212,180,104,0.65)";
      ctx.lineWidth = 1.4;
      ctx.stroke();
      ctx.beginPath();
      ctx.arc(0, 0, R * 1.18, 0, Math.PI * 2);
      ctx.strokeStyle = "rgba(212,180,104,0.14)";
      ctx.lineWidth = 8;
      ctx.stroke();
      ctx.restore();
      ...
      ctx.strokeStyle = "rgba(212,180,104,0.4)";
      ctx.lineWidth = 0.9;
      ctx.stroke();
      ctx.restore();
      ...
      const s1x =
        cx +
        Math.cos(t1) * R * 1.18 * Math.cos(0.45) -
        Math.sin(t1) * R * 1.18 * 0.28 * Math.sin(0.45);
      const s1y =
        cy +
        Math.cos(t1) * R * 1.18 * Math.sin(0.45) +
        Math.sin(t1) * R * 1.18 * 0.28 * Math.cos(0.45);
      const sg1b = ctx.createRadialGradient(s1x, s1y, 0, s1x, s1y, 18);
      sg1b.addColorStop(0, "rgba(255,225,130,0.4)");
      sg1b.addColorStop(1, "rgba(255,225,130,0)");
      ctx.beginPath();
      ctx.arc(s1x, s1y, 18, 0, Math.PI * 2);
      ctx.fillStyle = sg1b;
      ctx.fill();
      const sg1 = ctx.createRadialGradient(s1x, s1y, 0, s1x, s1y, 9);
      sg1.addColorStop(0, "rgba(255,245,180,1)");
      sg1.addColorStop(0.5, "rgba(212,180,104,0.8)");
      sg1.addColorStop(1, "rgba(198,167,94,0)");
      ctx.beginPath();
      ctx.arc(s1x, s1y, 9, 0, Math.PI * 2);
      ctx.fillStyle = sg1;
      ctx.fill();
      ctx.beginPath();
      ctx.arc(s1x, s1y, 2.5, 0, Math.PI * 2);
      ctx.fillStyle = "#fff";
      ctx.fill();
      ...
      const s2x =
        cx +
        Math.cos(t2) * R * 1.22 * 0.28 * Math.cos(-0.25) -
        Math.sin(t2) * R * 1.22 * Math.sin(-0.25);
      const s2y =
        cy +
        Math.cos(t2) * R * 1.22 * 0.28 * Math.sin(-0.25) +
        Math.sin(t2) * R * 1.22 * Math.cos(-0.25);
      const sg2b = ctx.createRadialGradient(s2x, s2y, 0, s2x, s2y, 14);
      sg2b.addColorStop(0, "rgba(180,230,180,0.35)");
      sg2b.addColorStop(1, "rgba(163,177,138,0)");
      ctx.beginPath();
      ctx.arc(s2x, s2y, 14, 0, Math.PI * 2);
      ctx.fillStyle = sg2b;
      ctx.fill();
      const sg2 = ctx.createRadialGradient(s2x, s2y, 0, s2x, s2y, 7);
      sg2.addColorStop(0, "rgba(200,240,200,1)");
      sg2.addColorStop(0.5, "rgba(163,177,138,0.8)");
      sg2.addColorStop(1, "rgba(163,177,138,0)");
      ctx.beginPath();
      ...
      >
        ...
        <div
          style={{
            ...
            inset: "-10%",
            background:
              "radial-gradient(circle, rgba(0,200,150,.2) 0%, transparent 60%)",
            filter: "blur(36px)",
            borderRadius: "50%",
            pointerEvents: "none",
          }}
      ...
      >
        ...
        <div
          style={{
            ...
            height: 32,
            background:
              "linear-gradient(to bottom,rgba(0,200,150,.6),transparent)",
            borderRadius: 1,
          }}
        />
      </div>
