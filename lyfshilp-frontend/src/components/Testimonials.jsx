...
export default function Testimonials() {
  const testimonials = [
    ...
    {
      text: "Very professional and friendly environment, all the subjects related books provided by the faculty. Teachers are very understanding and help you with all doubts even after class. Classes start on time and every topic is covered properly according to the schedule provided on the WhatsApp group!",
      name: "Amilia",
      img: AnnaImg,
    },
    {
          ...
          {testimonials.map((item, idx) => {
            ...
            return (
              <div
                ...
                ${getClassName(idx)}`}
              >
                <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300 border border-gray-200 p-5 sm:p-6 md:p-7 lg:p-8 flex flex-col">
                  {/* Testimonial Text */}
                  <div className="flex-grow mb-4 sm:mb-5 transition-all duration-500 ease-in-out max-h-full">
                    <svg
