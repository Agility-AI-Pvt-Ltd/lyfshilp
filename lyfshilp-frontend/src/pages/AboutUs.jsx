...
const STATS = [
  {
    ...
    sub: "Schools & colleges across India",
  },
  {
    value: "6,000+",
    label: "Students Impacted",
    sub: "Through fellowships, workshops & programmes",
  },
  {
    value: "250+",
    label: "Workshops Conducted",
    sub: "AI, ICT & gamified learning sessions",
  },
  {
    value: "85%",
    label: "Improvement Rate",
    sub: "Measurable growth with structured mentoring",
  },
];
...
const TEAM = [
  {
    ...
    title: "Founder & CEO",
    creds:
      "Stanford Seed · Stanford GSB · B.Tech NSUT · MBA IRMA · M.S. BITS Pilani",
    exp: "~10 Years",
...
export default function AboutUs() {
  useEffect(() => {
    document.title =
      "About Lyfshilp Academy | DPIIT EdTech | Incubated at IIIT Allahabad";
    ...
    setMeta(
      "description",
      "Lyfshilp Academy is a DPIIT-recognised EdTech startup incubated at IIIT Allahabad. Our mission: make AI-powered learning accessible to every student in India. Meet our founding team and advisory board.",
    );
    setMeta(
      "keywords",
      "Lyfshilp Academy about, DPIIT EdTech startup India, EdTech IIIT Allahabad, AI education startup India founding team",
    );
  }, []);
  ...
  return (
    <div
      style={{
        background: "var(--color-bg-primary, #0C2D1E)",
    ...
    >
      ...
      >
        <div
          style={{
            ...
            pointerEvents: "none",
            background:
              "radial-gradient(ellipse at 12% 55%, rgba(0,200,150,.1), transparent 50%), radial-gradient(ellipse at 86% 20%, rgba(201,168,76,.06), transparent 42%)",
          }}
        />
        <div
        ...
        >
          <Reveal>
            ...
            >
              On a Mission to Make AI-Powered
              <br />
              Learning <span className="ab-accent">Accessible to Every</span>
              <br />
              <span className="ab-gold">Student in India.</span>
            </h1>
            <p
              style={{
                fontSize: "clamp(.97rem,2vw,1.15rem)",
            ...
            >
              Lyfshilp Academy is a DPIIT-recognised EdTech startup incubated at
              IIIT Allahabad. We bridge the gap between the way students learn
              today and the skills they will need tomorrow.
            </p>
            <div
              style={{
                display: "flex",
        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid md:grid-cols-2 gap-10 items-center">
            ...
            <Reveal delay={0.1}>
              ...
              >
                We believe education goes beyond exams. Our mission is to
                prepare students with AI-powered preparation, mentorship and
                skills to succeed academically, professionally and personally.
              </p>
              <p
                style={{
                  color: "var(--color-text-muted, #7A9E8A)",
              ...
              >
                With 38 partner institutions and over 6,000 students impacted,
                our programmes are built on rigorous pedagogy, real academic
                outcomes, and deep respect for the school ecosystem.
              </p>
              <div
                style={{
                  padding: "16px 20px",
              ...
              >
                Powered by <strong>Lyfshilp Academy Pvt. Ltd.</strong> &amp;{" "}
                <strong>Agility AI Pvt. Ltd.</strong>
              </div>
            </Reveal>
          </div>
        </div>
      ...
      <section style={{ padding: "80px 24px" }}>
        <div className="max-w-6xl mx-auto">
          <Reveal className="text-center" style={{ marginBottom: 52 }}>
            ...
            <h2 className="ab-h2">
              The Minds Behind{" "}
              <span className="ab-accent">Lyfshilp Academy</span>
            </h2>
            <p
              style={{
                color: "var(--color-text-muted, #7A9E8A)",
            ...
            >
              Behind every student's success is a founding team that blends
              engineering, management, law, and finance.
            </p>
          </Reveal>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {TEAM.map(({ img, name, title, creds, exp, linkedin, bio }, i) => (
              <Reveal key={name} delay={i * 0.09}>
                <div
                  className="ab-card ab-card-hover h-full"
                ...
                >
                  ...
                  <div
                    style={{
                      ...
                      overflow: "hidden",
                      background:
                        "linear-gradient(135deg,rgba(0,200,150,.12),rgba(12,45,30,.9))",
                      display: "flex",
                      alignItems: "center",
                      justifyContent: "center",
                      position: "relative",
                  ...
                  >
                    <div>
                      {creds.split(" · ").map((c) => (
                        <span key={c} className="ab-cred-pill">
                          {c}
                        </span>
                      ))}
                    </div>
                    <div
                      style={{ height: 1, background: "rgba(0,200,150,.08)" }}
                    />
                    <p
                      style={{
                        color: "var(--color-text-muted, #7A9E8A)",
      ...
      {/* ── ADVISORY BOARD ── */}
      <section
        style={{ padding: "80px 24px", background: "rgba(201,168,76,.025)" }}
      >
        <div className="max-w-5xl mx-auto">
          <Reveal className="text-center" style={{ marginBottom: 52 }}>
      ...
      <section style={{ padding: "88px 24px" }}>
        <div className="max-w-2xl mx-auto text-center">
          <Reveal>
            <div className="ab-section-label" style={{ marginBottom: 14 }}>
              Work With Us
            </div>
            <h2
              style={{
            ...
            >
              Whether you're a school, a college, a corporate, or an individual
              — there's a place for you in the Lyfshilp ecosystem.
            </p>
            <div
              style={{
                display: "flex",
            ...
            >
              <Link
                ...
                style={{
                  ...
                  textDecoration: "none",
                  fontSize: ".92rem",
                  boxShadow: "0 6px 22px rgba(0,200,150,.28)",
