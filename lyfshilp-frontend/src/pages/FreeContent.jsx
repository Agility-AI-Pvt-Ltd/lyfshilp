...
import CareerGuidanceWidget from "../components/CareerGuidanceWidget.jsx";
...
export default function FreeContent() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-orange-50 to-yellow-50 pt-24 pb-16 px-4 sm:px-6 lg:px-12">
      ...
      <div className="bg-gradient-to-br from-white to-blue-50 rounded-3xl p-8 sm:p-12 shadow-2xl border border-blue-200 mb-12">
        <h3 className="text-3xl sm:text-4xl font-black text-center mb-6">
          Find Your{" "}
        ...
        <p className="text-center text-gray-700 text-lg max-w-3xl mx-auto mb-8">
          Not sure which courses you're eligible for? Use our{" "}
          <span className="font-bold text-blue-700">
            Smart Career Guidance Tool
          </span>{" "}
          to discover universities and programs that match your profile.
        </p>
          ...
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md p-6 relative">
            ...
            <form className="space-y-4" onSubmit={submitPdfForm}>
              ...
              <button
                type="submit"
                disabled={loading}
                className={`w-full py-3 rounded-xl font-bold text-white transition ${loading
              ...
              {formMsg && (
                <div
                  className={`text-sm text-center font-semibold ${formMsgType === "success" ? "text-green-600" : "text-red-600"
                    }`}
                >
                  {formMsg}
                </div>
