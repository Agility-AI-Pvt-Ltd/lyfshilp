...
const jobs = [
  ...
  },
  {
    ...
    category: "Sales",
    postedOn: "May 1, 2025",
    summary: `We are looking for a Business Development Executive to expand Lyfshilp Academy’s footprint across schools, colleges, and coaching institutes.`,
    requirements: [
      "Graduation in any stream (MBA preferred).",
      "Strong communication & negotiation skills.",
      "Target-oriented and networking skills."
    ],
    responsibilities: [
      "Identify and pursue new business opportunities.",
      "Build and maintain strong client relationships.",
      "Pitch and present company products/services.",
      "Achieve sales targets & report progress."
    ],
    benefits: [
      "Growth opportunities with performance incentives",
      "Career development & training support",
      "Health benefits and paid leaves (as per policy)"
    ]
    }
];

export default function Job2({ jobId }) {
    ...
    {jobs
      ...
      .map((related) => {
        ...
        return (
          <Link
            key={related.id}
            to={routeMap[related.id] || "/career"} // ✅ correct route
