...
const jobs = [
   {
    id: 1,
    title: "Quant & Reasoning Faculty",
    location: "Delhi",
    mode: "Full-Time",
    salary: "4–5 LPA",
    category: "Teaching",
    postedOn: "Apr 23, 2025",
    summary: `Responsible for training, guiding, and preparing students in Quantitative Aptitude and Logical Reasoning to enhance their problem-solving and analytical skills.`,
    requirements: [
      "Bachelor’s degree in Mathematics/Engineering/Commerce (MBA preferred).",
      "Strong command over Quantitative Aptitude & Logical Reasoning.",
      "Good communication and teaching/presentation skills.",
      "Ability to simplify complex concepts for students."
    ],
    responsibilities: [
      "Teach and mentor students in Quantitative Aptitude & Logical Reasoning.",
      "Design practice materials, mock tests, and question banks.",
      "Conduct doubt-solving sessions and monitor student performance.",
      "Stay updated with latest exam patterns (CAT, SSC, Banking, etc.)."
    ],
    benefits: [
      "Competitive salary package",
      "Career growth opportunities in EdTech sector",
...
export default function Job3({ jobId }) {
