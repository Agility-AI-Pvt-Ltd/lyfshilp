...
import {
  LIVE_SESSION_GALLERY,
  LIVE_SESSION_IMAGES,
} from "../assets/summer-sessions/images.js";
...
/** slice(4) is 7 URLs; last repeats ss10 for layout parity; investment banner uses ss7 via `problemWorkshop` */
const [
  heroWorkshopA,
  heroWorkshopB,
  problemWorkshop,
...
const investWorkshop = problemWorkshop;
...
function PrimaryCta({ children, href, className = "", onClick }) {
  ...
  return (
    <span
      className={`${sharedClass} cursor-not-allowed opacity-40`}
      style={style}
    >
      {children}
    </span>
...
function GoldCta({ children, href, className = "", onClick }) {
  const base = `rounded-xl px-4 py-2 text-sm font-semibold text-black no-underline transition-all duration-300 hover:scale-[1.05] hover:shadow-[0_10px_36px_rgba(212,175,55,0.35)] active:scale-[0.98] motion-reduce:transition-colors inline-flex items-center justify-center ${className}`;
  if (!href) {
    return (
      <span
    ...
    >
      ...
      <header
        className={`sticky top-0 z-50 border-b backdrop-blur-xl transition-all duration-500 ${
          navSolid
            ? "border-white/10 bg-black/80 shadow-lg shadow-black/40"
      ...
      {!PAYMENT_URL ? (
        ...
        >
          ...
          <code className="text-white/90">lyfshilp-frontend/.env</code> and
          restart the dev server so reserve links work.
        </div>
      ) : null}
      ...
      <section className="relative z-10 mx-auto max-w-4xl px-4 pb-20 pt-16 text-center">
        ...
        >
          ...
          <strong className="text-white">real AI-built project</strong> — plus
          the exact map to build your own{" "}
        ...
        >
          <span className="line-through text-white/40 transition-colors hover:text-white/55">
            ₹499
          </span>
          <ArrowRight
      ...
      <section className="relative z-10 mx-auto max-w-6xl border-t border-white/5 px-4 py-20">
        <Reveal>
          ...
          <h2 className="fx-head mb-4 max-w-4xl text-3xl font-black sm:text-4xl">
            Your child uses ChatGPT every day. Are they actually ahead – or just
            keeping up?
          </h2>
          <p className="mb-10 max-w-2xl text-lg text-white/55">
            There is a massive difference between using AI and commanding it.
            Almost every student is stuck at level one.
          </p>
        </Reveal>
        <Reveal delay={40}>
      ...
      <section className="relative z-10 mx-auto max-w-6xl border-t border-white/5 px-4 py-20">
        <Reveal>
          ...
          <h2 className="fx-head mb-3 text-3xl font-black sm:text-4xl">
            You Will Leave With —
          </h2>
          <p className="mb-8 max-w-xl text-white/55">
            Not slides. Not theory. Real things you can use the same day.
          </p>
        </Reveal>
        <Reveal delay={40}>
        ...
        <Reveal delay={60}>
          <div className="divide-y divide-white/10 overflow-hidden rounded-2xl border border-white/10 shadow-[0_20px_60px_-20px_rgba(0,0,0,0.75)]">
            {[
              ...
              >
                <span
                  className="fx-head text-2xl font-black tabular-nums"
                  style={{ color: GOLD }}
                >
                  {row.n}
                </span>
      ...
      {/* Gallery — compact collage */}
      <section className="relative z-10 mx-auto w-full max-w-4xl border-t border-white/5 px-4 py-20">
        <Reveal>
          <p className="fx-overline mb-4" style={{ color: GOLD }}>
            From our workshops
          </p>
          <h2 className="fx-head mb-3 text-3xl font-black sm:text-4xl">
            Students Who Already Made the Shift
          </h2>
          <p className="mb-8 text-white/55">
            Real sessions. Real students. Real projects.
          </p>
        </Reveal>
        <Reveal delay={80}>
          <div className="flex w-full flex-col gap-2.5 md:gap-3">
            <div className="flex w-full flex-col gap-2.5 md:flex-row md:gap-3">
              <div className="group/g1 relative max-h-[400px] w-full flex-1 overflow-hidden rounded-2xl border border-white/10 shadow-lg transition-all duration-500 hover:border-emerald-500/35 hover:shadow-[0_0_40px_-8px_rgba(13,159,114,0.25)] md:min-h-[110px]">
                <WebinarPhoto
              ...
              <div className="flex w-full shrink-0 flex-col gap-2.5 md:w-[min(40%,200px)] md:gap-3">
                <div className="group/g2 relative max-h-[200px] w-full flex-1 overflow-hidden rounded-2xl border border-white/10 shadow-md transition-all duration-500 hover:border-amber-500/35 hover:shadow-lg md:min-h-[52px]">
                  <WebinarPhoto
                ...
                <div className="group/g3 relative max-h-[200px] w-full flex-1 overflow-hidden rounded-2xl border border-white/10 shadow-md transition-all duration-500 hover:border-amber-500/35 hover:shadow-lg md:min-h-[52px]">
                  <WebinarPhoto
            ...
            <div className="group/g4 relative max-h-[300px] w-full overflow-hidden rounded-2xl border border-white/10 shadow-lg transition-all duration-500 hover:border-emerald-500/35 hover:shadow-[0_0_36px_-6px_rgba(13,159,114,0.2)] sm:min-h-[64px]">
              <WebinarPhoto
      ...
      {/* Ferrari — 60% width */}
      <section className="relative z-10 mb-16 w-full max-w-none overflow-hidden py-16 text-center shadow-[0_24px_80px_-30px_rgba(0,0,0,0.9)] sm:mb-20 sm:py-20">
        <Reveal className="relative z-10">
          <div className="mb-12 flex w-full justify-center sm:mb-14 md:mb-16">
            <div className="relative h-[min(40vh,320px)] w-[60%] min-w-0 max-w-full overflow-hidden rounded-2xl border border-white/15 shadow-[0_12px_40px_-8px_rgba(0,0,0,0.6)] ring-1 ring-white/10 sm:h-[min(45vh,420px)]">
              <img src="" alt="" />
              <WebinarPhoto
                src={ferrariWorkshop}
                alt=""
                className="h-full w-full"
                imgClassName="object-cover object-center opacity-[0.88] motion-reduce:opacity-100"
              />
              <div className="pointer-events-none absolute inset-0 bg-gradient-to-t from-black/25 via-transparent to-black/10" />
            </div>
          </div>
          <h2 className="fx-head mx-auto mb-6 max-w-3xl px-4 text-2xl font-black leading-snug sm:text-3xl md:text-4xl">
            You are sitting in a{" "}
            <span
              className="relative inline-block text-[1.05em]"
              style={{ color: GOLD }}
            >
              Ferrari.
            ...
            Using it to go to the grocery store. Every student around you is
            doing the same thing.
          </h2>
          <p className="mx-auto mb-10 max-w-3xl px-4 text-lg text-white/55">
            This session teaches you to shift gears — from passenger to driver,
            from user to commander.
          </p>
        </Reveal>
        <Reveal delay={100} className="relative z-10 flex justify-center px-4">
          <PrimaryCta href={PAYMENT_URL} onClick={trackLiveWebinarPaymentClick}>
      ...
      <section className="relative z-10 mx-auto max-w-6xl border-t border-white/5 px-4 py-20">
        <Reveal>
          <h2 className="fx-head mb-10 text-center text-3xl font-black">
            This Session Is For —
          </h2>
        </Reveal>
        <Reveal delay={50}>
        ...
        <div className="grid gap-10 md:grid-cols-2 md:gap-16">
          ...
          <Reveal delay={120}>
            <div className="rounded-2xl border border-white/5 bg-black/20 p-6 transition-all duration-500 hover:border-amber-500/20 hover:shadow-[0_0_40px_-12px_rgba(212,175,55,0.12)] md:p-8">
              <h3 className="mb-6 text-xs font-bold uppercase tracking-widest text-white/45">
                Skip this if
              </h3>
              <ul className="space-y-4">
                {[
      ...
      <section className="relative z-10 mx-auto max-w-6xl border-t border-white/5 px-4 py-20">
        <div className="flex flex-col items-center gap-12 lg:flex-row lg:gap-20">
          ...
          <Reveal delay={80} className="flex-1 space-y-5">
            ...
            <h2 className="fx-head text-3xl font-black sm:text-4xl">
              &quot;Why is it only ₹99?&quot;
            </h2>
            ...
            <p className="leading-relaxed text-white/65">
              ₹99 is not the price of this session. It is the price of your{" "}
              <strong className="text-white">commitment.</strong> We want
              students who will actually show up, build something, and do the
              work — not people who register and forget.
            </p>
            <p className="leading-relaxed text-white/65">
              <strong className="text-white">
                If you are serious about this, ₹99 is nothing.
              </strong>{" "}
              If you are not — this session is not for you.
            </p>
            <PrimaryCta
              href={PAYMENT_URL}
              onClick={trackLiveWebinarPaymentClick}
            >
              I&apos;m Serious — Pay ₹99
              <ArrowRight className="h-5 w-5 transition-transform duration-300 group-hover:translate-x-1" />
            </PrimaryCta>
      ...
      {/* Investment card */}
      <section className="relative z-10 mx-auto w-[70%] max-w-full min-w-0 border-t border-white/5 px-4 py-20">
        <Reveal>
          <p
            className="fx-overline mb-4 text-center"
            style={{ color: GOLD_SOFT }}
          >
            Your investment
          </p>
          <h2 className="fx-head mb-2 text-center text-3xl font-black">
            Everything You Get.
          </h2>
          <h2 className="fx-head mb-10 text-center text-3xl font-black">
            For ₹99.
          ...
          >
            <div className="group/inv relative aspect-[2.4/1] max-h-[220px] w-full border-b border-white/10 sm:max-h-[260px]">
              <WebinarPhoto
                ...
                imgClassName="object-center transition-transform duration-700 group-hover/inv:scale-[1.04]"
              />
            ...
            <ul className="divide-y divide-white/10">
              {[
                ...
                >
                  ...
                  <span className="shrink-0 text-xs line-through text-white/35">
                    {strike}
                  </span>
                </li>
              ))}
            ...
            <div className="border-t border-white/10 px-6 py-8 text-center">
              ...
              <p
                className="mb-2 text-4xl font-black tabular-nums motion-safe:animate-fxTick"
                style={{ color: GOLD }}
              >
                ₹99
              </p>
              ...
              <div className="flex flex-wrap justify-center gap-6 text-xs text-white/50">
                <span className="inline-flex items-center gap-1 transition-colors hover:text-white/70">
                  <Shield className="h-4 w-4" style={{ color: GREEN }} /> Secure
                  via Razorpay
                </span>
                <span className="inline-flex items-center gap-1 transition-colors hover:text-white/70">
                  <Smartphone className="h-4 w-4" style={{ color: GREEN }} />{" "}
      ...
      <section className="relative z-10 mx-auto max-w-4xl border-t border-white/5 px-4 py-24 text-center">
        <Reveal>
          ...
          <p className="mb-10 text-white/50">
            The ones who scroll past will still be in first gear.
          </p>
        </Reveal>
        <Reveal delay={60}>
          <div className="mb-10 flex justify-center gap-3 sm:gap-4">
            {[
              ...
              >
                <div
                  className="fx-head text-2xl font-black tabular-nums sm:text-3xl"
                  style={{ color: GOLD }}
                >
                  {u.v}
                </div>
                <div className="mt-1 text-[0.65rem] uppercase tracking-widest text-white/40">
                  {u.l}
                </div>
              </div>
            ))}
        ...
        <Reveal delay={120}>
          ...
          <p className="mt-6 text-sm text-white/45">
            <span
              className="inline-flex items-center gap-1 transition-colors hover:text-amber-200/90"
              style={{ color: GOLD }}
            >
      ...
      <Reveal>
        <footer className="relative z-10 mx-auto max-w-6xl border-t border-white/5 px-4 py-12 text-center text-xs text-white/40">
          ...
          <p className="mt-2 transition-colors hover:text-white/55">
            Building AI Commanders, One Student at a Time.
          </p>
        </footer>
      </Reveal>
    </div>
